...
namespace kosmic::lua::ver_5_2_3::optable {
      ...
      static std::map<OpCode, optable_encoding> opencodings = {
          ...
          {OpCode::OP_UNM, {OpCode::OP_UNM, {operand_encoding::A, operand_encoding::B}}},                                /* 13 */
          {OpCode::OP_NOT, {OpCode::OP_NOT, {operand_encoding::A, operand_encoding::B}}},                                /* 14 */
          {OpCode::OP_LEN, {OpCode::OP_LEN, {operand_encoding::A, operand_encoding::B}}},                                /* 15 */
          {OpCode::OP_CONCAT, {OpCode::OP_CONCAT, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},     /* 16 */
          {OpCode::OP_JMP, {OpCode::OP_JMP, {operand_encoding::A, operand_encoding::sBx}}},                              /* 17 */
          {OpCode::OP_EQ, {OpCode::OP_EQ, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},             /* 18 */
          {OpCode::OP_LT, {OpCode::OP_LT, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},             /* 19 */
          {OpCode::OP_LE, {OpCode::OP_LE, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},             /* 1a */
          {OpCode::OP_TEST, {OpCode::OP_TEST, {operand_encoding::A, operand_encoding::C}}},                              /* 1b */
          {OpCode::OP_TESTSET, {OpCode::OP_TESTSET, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},   /* 1c */
          {OpCode::OP_CALL, {OpCode::OP_CALL, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},         /* 1d */
          {OpCode::OP_TAILCALL, {OpCode::OP_TAILCALL, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}}, /* 1e */
          {OpCode::OP_RETURN, {OpCode::OP_RETURN, {operand_encoding::A, operand_encoding::B}}},                          /* 1f */
          {OpCode::OP_FORLOOP, {OpCode::OP_FORLOOP, {operand_encoding::A, operand_encoding::sBx}}},                      /* 20 */
          {OpCode::OP_FORPREP, {OpCode::OP_FORPREP, {operand_encoding::A, operand_encoding::sBx}}},                      /* 21 */
          {OpCode::OP_TFORCALL, {OpCode::OP_TFORCALL, {operand_encoding::A, operand_encoding::C}}},                      /* 22 */
          {OpCode::OP_TFORLOOP, {OpCode::OP_TFORLOOP, {operand_encoding::A, operand_encoding::sBx}}},                    /* 23 */
          {OpCode::OP_SETLIST, {OpCode::OP_SETLIST, {operand_encoding::A, operand_encoding::B, operand_encoding::C}}},   /* 24 */
          {OpCode::OP_CLOSURE, {OpCode::OP_CLOSURE, {operand_encoding::A, operand_encoding::Bx}}},                       /* 25 */
          {OpCode::OP_VARARG, {OpCode::OP_VARARG, {operand_encoding::A, operand_encoding::B}}},                          /* 26 */
          {OpCode::OP_EXTRAARG, {OpCode::OP_EXTRAARG, {operand_encoding::Ax}}}                                           /* 27 */
      };
      ...
      static std::map<OpCode, optable_kind> opkinds = {
          ...
          {OpCode::OP_UNM, {OpCode::OP_UNM, {operand_kind::dest, operand_kind::reg}}},                                             /* 13 */
          {OpCode::OP_NOT, {OpCode::OP_NOT, {operand_kind::dest, operand_kind::reg}}},                                             /* 14 */
          {OpCode::OP_LEN, {OpCode::OP_LEN, {operand_kind::dest, operand_kind::reg}}},                                             /* 15 */
          {OpCode::OP_CONCAT, {OpCode::OP_CONCAT, {operand_kind::dest, operand_kind::reg, operand_kind::reg}}},                    /* 16 */
          {OpCode::OP_JMP, {OpCode::OP_JMP, {operand_kind::val, operand_kind::jmp}}},                                              /* 17 */
          {OpCode::OP_EQ, {OpCode::OP_EQ, {operand_kind::val, operand_kind::reg, operand_kind::reg}}},                             /* 18 */
          {OpCode::OP_LT, {OpCode::OP_LT, {operand_kind::val, operand_kind::reg, operand_kind::reg}}},                             /* 19 */
          {OpCode::OP_LE, {OpCode::OP_LE, {operand_kind::val, operand_kind::reg, operand_kind::reg}}},                             /* 1a */
          {OpCode::OP_TEST, {OpCode::OP_TEST, {operand_kind::reg, operand_kind::val}}},                                            /* 1b */
          {OpCode::OP_TESTSET, {OpCode::OP_TESTSET, {operand_kind::reg, operand_kind::reg, operand_kind::val}}},                   /* 1c */
          {OpCode::OP_CALL, {OpCode::OP_CALL, {operand_kind::reg, operand_kind::val_multret, operand_kind::val_multret}}},         /* 1d */
          {OpCode::OP_TAILCALL, {OpCode::OP_TAILCALL, {operand_kind::reg, operand_kind::val_multret, operand_kind::val_multret}}}, /* 1e */
          {OpCode::OP_RETURN, {OpCode::OP_RETURN, {operand_kind::reg, operand_kind::val_multret}}},                                /* 1f */
          {OpCode::OP_FORLOOP, {OpCode::OP_FORLOOP, {operand_kind::reg, operand_kind::jmp}}},                                      /* 20 */
          {OpCode::OP_FORPREP, {OpCode::OP_FORPREP, {operand_kind::reg, operand_kind::jmp}}},                                      /* 21 */
          {OpCode::OP_TFORCALL, {OpCode::OP_TFORCALL, {operand_kind::reg, operand_kind::val}}},                                    /* 22 */
          {OpCode::OP_TFORLOOP, {OpCode::OP_TFORLOOP, {operand_kind::reg, operand_kind::jmp}}},                                    /* 23 */
          {OpCode::OP_SETLIST, {OpCode::OP_SETLIST, {operand_kind::reg, operand_kind::val_multret, operand_kind::val_multret}}},   /* 24 */
          {OpCode::OP_CLOSURE, {OpCode::OP_CLOSURE, {operand_kind::reg, operand_kind::p_idx}}},                                    /* 25 */
          {OpCode::OP_VARARG, {OpCode::OP_VARARG, {operand_kind::reg, operand_kind::val_multret}}},                                /* 26 */
          {OpCode::OP_EXTRAARG, {OpCode::OP_EXTRAARG, {operand_kind::reg}}}                                                        /* 27 */
      };
      ...
      static std::map<OpCode, optable_descriptor> opdescriptor = {
          ...
          {OpCode::OP_UNM, {"OP_UNM", "unm", "Unary minus A to B and load results to A.", {"dest(Register)", "src(Register)"}}},                                                                                                                                                           /* 13 */
          {OpCode::OP_NOT, {"OP_NOT", "not", "Unary not A to B and load results to A.", {"dest(Register)", "src(Register)"}}},                                                                                                                                                             /* 14 */
          {OpCode::OP_LEN, {"OP_LEN", "len", "Unary length of table B and load results to A.", {"dest(Register)", "src(Register)"}}},                                                                                                                                                      /* 15 */
          {OpCode::OP_CONCAT, {"OP_CONCAT", "concat", "Concat string where start of stack B to C.", {"dest(Register)", "src(Register)", "src(Register)"}}},                                                                                                                                /* 16 */
          {OpCode::OP_JMP, {"OP_JMP", "jmp", "Jump to sBx if A is not 0 then all upvalues >= A - 1 will be closed.", {"val(Value)", "jmp(Jump)"}}},                                                                                                                                        /* 17 */
          {OpCode::OP_EQ, {"OP_EQ", "eq", "Compare equal B to C and if comparision is not A skip next instruction.", {"val(Value)", "src(Register)", "src(Register)"}}},                                                                                                                   /* 18 */
          {OpCode::OP_LT, {"OP_LT", "lt", "Compare less than B to C and if comparision is not A skip next instruction.", {"val(Value)", "src(Register)", "src(Register)"}}},                                                                                                               /* 19 */
          {OpCode::OP_LE, {"OP_LE", "le", "Compare less than equal B to C and if comparision is not A skip next instruction.", {"val(Value)", "src(Register)", "src(Register)"}}},                                                                                                         /* 1a */
          {OpCode::OP_TEST, {"OP_TEST", "test", "Compare A to C and if false skip next instruction", {"src(Register)", "val(Value)"}}},                                                                                                                                                    /* 1b */
          {OpCode::OP_TESTSET, {"OP_TESTSET", "testset", "Compare B to C and if false skip next instruction else set A to B.", {"src(Register)", "src(Register)", "val(Value)"}}},                                                                                                         /* 1c */
          {OpCode::OP_CALL, {"OP_CALL", "call", "Call A with B args and C return.", {"src(Register)", "multret(Multret Value)", "multret(Multret Value)"}}},                                                                                                                               /* 1d */
          {OpCode::OP_TAILCALL, {"OP_TAILCALL", "tailcall", "Return call A with B args and C return.", {"src(Register)", "multret(Multret Value)", "multret(Multret Value)"}}},                                                                                                            /* 1e */
          {OpCode::OP_RETURN, {"OP_RETURN", "return", "Return from start A to A + B - 2.", {"src(Register)", "multret(Multret Value)"}}},                                                                                                                                                  /* 1f */
          {OpCode::OP_FORLOOP, {"OP_FORLOOP", "forloop", "For loop follows for format starting A with sBx jump.", {"src(Register)", "jmp(Jump)"}}},                                                                                                                                        /* 20 */
          {OpCode::OP_FORPREP, {"OP_FORPREP", "forprep", "For loop follows for format starting A with sBx jump.", {"src(Register)", "jmp(Jump)"}}},                                                                                                                                        /* 21 */
          {OpCode::OP_TFORCALL, {"OP_TFORCALL", "tforcall", "For prep calls iterator function.", {"src(Register)", "val(Value)"}}},                                                                                                                                                        /* 22 */
          {OpCode::OP_TFORLOOP, {"OP_TFORLOOP", "tforloop", "For loop follows T for format starting A with sBx jump.", {"src(Register)", "jmp(Jump)"}}},                                                                                                                                   /* 23 */
          {OpCode::OP_SETLIST, {"OP_SETLIST", "setlist", "Sets the values for a range of array elements in a table referenced by A, B is the number of elements to set, C encodes the block number initialized.", {"src(Register)", "multret(Multret Value)", "multret(Multret Value)"}}}, /* 24 */
          {OpCode::OP_CLOSURE, {"OP_CLOSURE", "closure", "Set to kvalue proto.", {"src(Register)", "pidx(Proto Index)"}}},                                                                                                                                                                 /* 25 */
          {OpCode::OP_VARARG, {"OP_VARARG", "vararg", "Set range A + 1 to A + B - e1 to vararg.", {"src(Register)", "multret(Multret Value)"}}},                                                                                                                                           /* 26 */
