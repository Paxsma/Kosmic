...
void set_data(std::shared_ptr<kosmic::lua::ver_5_3_4::disassembly> &buffer, const Proto *p, const OpCode op) {

      const auto descriptor = kosmic::lua::ver_5_3_4::optable::opdescriptor[op];
      const auto encoding = kosmic::lua::ver_5_3_4::optable::opencodings[op];
      const auto kind = kosmic::lua::ver_5_3_4::optable::opkinds[op];
      ...
      for (auto i = 0u; i < op_count; ++i) {
            ...
            auto current_operand = std::make_shared<kosmic::lua::ver_5_3_4::operand>();
            ...
            switch (operand) {
                  ...
                  case kosmic::lua::ver_5_3_4::optable::operand_encoding::A: {
                        operand_value = GETARG_A(*buffer->code);
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_encoding::Ax: {
                        operand_value = GETARG_Ax(*++buffer->code);
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_encoding::B: {
                        operand_value = GETARG_B(*buffer->code);
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_encoding::Bx: {
                        operand_value = GETARG_Bx(*buffer->code);
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_encoding::C: {
                        operand_value = GETARG_C(*buffer->code);
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_encoding::sBx: {
            ...
            switch (current_operand->kind) {
                  ...
                  case kosmic::lua::ver_5_3_4::optable::operand_kind::jmp: {
                  ...
                  case kosmic::lua::ver_5_3_4::optable::operand_kind::reg:
                  case kosmic::lua::ver_5_3_4::optable::operand_kind::dest: {
                        current_operand->reg = std::uint16_t(operand_value);
                        buffer->data += 'r' + std::to_string(current_operand->reg) + split;
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_kind::val: {
                        current_operand->val = operand_value;
                        buffer->data += std::to_string(current_operand->val) + split;
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_kind::val_multret: {
                        current_operand->val = --operand_value;
                        buffer->data += std::to_string(current_operand->val) + split;
                        break;
                  }

                  case kosmic::lua::ver_5_3_4::optable::operand_kind::p_idx: {
                  ...
                  case kosmic::lua::ver_5_3_4::optable::operand_kind::k_idx: {
...
void kosmic::lua::ver_5_3_4::disassemble(const std::uintptr_t addr, const Proto *p, std::shared_ptr<kosmic::lua::ver_5_3_4::disassembly> &buffer) {
...
void kosmic::lua::ver_5_3_4::disassemble(const Proto *p, std::vector<std::shared_ptr<disassembly>> &buffer) {
...
std::vector<std::shared_ptr<kosmic::lua::ver_5_3_4::disassembly>> kosmic::lua::ver_5_3_4::disassemble(const Proto *p) {
